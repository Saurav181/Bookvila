...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"  >
      <div class="container">
        <div class="navbar-header" >
          ...
          <div class="row">
            <a class="navbar-brand" href="index.php" col-md-3>Bookvilla</a>
    ...
    <div class="jumbotron" style="  background: url('https://www.hindustantimes.com/rf/image_size_960x540/HT/p2/2019/04/22/Pictures/_12dee196-64e2-11e9-9706-c5428a3382f6.jpg') no-repeat center center;background-size: cover;height:400px
;
  " >
      <div class="container">
        <h1 style="text-align:center; margin:5% auto;color:white;">WELCOME TO THE BOOKVILLA</h1>   
        <p style="text-align:center; margin:5% auto;color:white;font-size:30px">Here you can find your favourite books and order them online!</p>     
      </div>
    </div>
    <?php } ?>
